...
public class Ex01Array {
    public static void main(String[] args) {
        ...
        // 변수이름 = 값
        // 으로 저장했다.
        // 배열의 경우 우리가 해당 배열의 몇번쨰 칸에 저장할 지를 지정해야 한다.
        ...
        // 변수이름을 적어주기만 하면 되었지만
        // 배열의 경우, 우리가 몇번째 칸에 지정된 값을 호출하는 것인지
        // 지정해야 한다.
        // 이때에는 배열이름 [칸 번호] 로 지정하게 된다.
        
        // int 배열 intArray의 0번쨰칸에 저장된 값을 화면에 출력해라
        ...
        // null이란, 참조형 데이터타입에 연결된 해당 메모리 주소칸이 아직 준비가 안되어 있는 상태로써
        // 제대로 초기화를 하지 않을 경우에는 해당 칸의 메소드를 실행 시킬 수 없다.
